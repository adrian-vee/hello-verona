...
const faqs = [
  ...
  { q_it: "Quanto dista il centro di Verona?",                   q_en: "How far is Verona city center?",                    a_it: "Il centro (Piazza Bra) dista circa 3 km: 7 minuti in auto.", a_en: "The center (Piazza Bra) is about 3 km: 7 minutes by car.", cat: "location" },
  { q_it: "Quanto dista la Fiera di Verona?",                    q_en: "How far is the Verona Trade Fair?",                 a_it: "La Fiera (Veronafiere) è a soli 1 km — circa 3 minuti in auto! Ideale per Vinitaly, Fieracavalli, Motor Bike Expo.", a_en: "The Trade Fair (Veronafiere) is only 1 km away — about 3 minutes by car! Ideal for Vinitaly, Fieracavalli, Motor Bike Expo.", cat: "location" },
